...
2. **Connect your GitHub repository**
   ...
   - Select your GitHub repository containing the blog application

3. **Configure project settings**
   - Vercel should automatically detect that this is a Node.js project
   - Set the root directory to `/` (if not already selected)
   - Make sure the build command is set to `npm run build`
   - Set the output directory to `client/build`

4. **Set environment variables**
   - In the project settings, navigate to the "Environment Variables" tab
